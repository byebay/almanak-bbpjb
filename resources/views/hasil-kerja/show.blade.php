<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Hasil Kerja: {{ $user->name }}</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
                ...
                <form action="{{ route('hasil-kerja.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="title" class="block font-bold">Judul/Nama Kegiatan:</label>
                    ...
                    <div class="mb-4">
                        <label for="work_file" class="block font-bold">Pilih File:</label>
