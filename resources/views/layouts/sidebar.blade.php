...
>
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
        ...
        <x-nav-link :href="route('sebaran-pegawai')" :active="request()->routeIs('sebaran-pegawai')" class="w-full flex items-center p-2 rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900">
        ...
        @if(Auth::check() && Auth::user()->isSuperAdmin())
            <x-nav-link :href="route('admin.wilayah.index')" :active="request()->routeIs('admin.wilayah.*')" class="w-full flex items-center p-2 rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900">
