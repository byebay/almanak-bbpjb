<x-app-layout>
                        ...
                        <div class="p-6 text-gray-900">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <div class="relative h-64 overflow-x-auto">
                                        <div class="h-full" style="min-width: 600px;">
                                            <canvas id="chartTotalProgramAdmin"></canvas>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <div class="relative h-64 overflow-x-auto">
                                        <div class="h-full" style="min-width: 600px;">
                                            <canvas id="chartPengembanganAdmin"></canvas>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-gray-200 shadow-sm">
                                    ...
                                    <div class="relative h-64 overflow-x-auto">
                                        <div class="h-full" style="min-width: 600px;">
                                            <canvas id="chartPembinaanAdmin"></canvas>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Kumpulkan daftar kode wilayah unik dari data program yang ada
            ...
            // Function helper render chart
            function renderBarChart(canvasId, chartLabels, chartData, barColor, borderColor) {
